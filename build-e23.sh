...
ASSET_PARTS="$ROOT/assets/e23-assets.part1 $ROOT/assets/e23-assets.part2 $ROOT/assets/e23-assets.part3 $ROOT/assets/e23-assets.part4"
...
python3 "$ROOT/tools/extract_e23_assets.py" \
    --parts $ASSET_PARTS \
    --output "$RESOURCE_DIR"
...
MIDlet-1: E23 96 in 1, , e23.E23Midlet
